...
## Overview
Use the bundled script (`skills/ng-lesson-sync/scripts/ng_lesson_sync.py`) to pull official ng_lesson notebooks, helper files, and assets into `references/ng_lesson/`.
...
3) Preview the official lesson URLs:
   - `python skills/ng-lesson-sync/scripts/ng_lesson_sync.py --list-only`
4) Sync with filters and batching if needed:
   - `python skills/ng-lesson-sync/scripts/ng_lesson_sync.py --module-label "Module 2"`
   - `python skills/ng-lesson-sync/scripts/ng_lesson_sync.py --lesson-name "Lesson Name"`
...
- The script is stored in `skills/ng-lesson-sync/scripts/ng_lesson_sync.py`.
